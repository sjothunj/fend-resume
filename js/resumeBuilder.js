...
//    "picture": "http://www.sjothun.com/img/main/sjothun.jpg",
    "picture": "images/Jon_kayak2.jpg",
    "skills": [
        "product management",
        "project management",
	...
	displayBio: function () {
		...
		while (skillsIndex<bio.skills.length) {
			formattedSkillset = HTMLskills.replace("%data%",bio.skills[skillsIndex]);
...
var work = {
	...
	displayWork: function () {
		for (jobs in work.jobs) {
			...
			var formattedLocation = HTMLworkLocation.replace("%data%",work.jobs[jobs].city);
